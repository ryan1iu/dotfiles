...
_G.packer_plugins = {
  ...
  ["Trans.nvim"] = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/Trans.nvim",
  ...
  ["formatter.nvim"] = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/formatter.nvim",
  ...
  ["nvim-lastplace"] = {
    loaded = true,
    path = "/home/ryan/.local/share/nvim/site/pack/packer/start/nvim-lastplace",
